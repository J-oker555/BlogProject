 ...
 */
final class Version20231123153136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD auteur_id INT NOT NULL, ADD article_id INT DEFAULT NULL');
